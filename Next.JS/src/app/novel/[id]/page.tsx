...
const NovelPage = ({ params: { id } }: Props) => {
    ...
    return (
        <article className="max-w-5xl mx-auto text-white">
            <section className="flex gap-2 ">
                {novel.image && (
                    <img height={200} width={200} src={novel.image} alt="Image" />
                )}
                ...
                <div className="p-2 flex flex-col">
                    ...
                    <form onSubmit={handleAddAuthor} className="mt-5 space-x-2">
                        ...
                        <button
                            className="border bg-cyan-500 p-2 rounded-lg disabled:text-black disabled:cursor-not-allowed"
                            disabled={!name}
                        >
                            Add Author
                        </button>
